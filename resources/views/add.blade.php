    ...
    <div class="container">
        <div class="row d-flex vh-100 justify-content-center align-content-center">
            <div class="col-5 bg-white p-5 shadow">
                <h1 class="text-center pb-4">Add New Records</h1>
                <form class="d-flex flex-column" action="{{ route('insert') }}" method="POST">
                    @csrf
                    <div class="mb-3 inp">
                        <input type="text" class="inpbox @error('num') ers @enderror" placeholder="Enter BatchNo."
                    ...
                    <div class="mb-3 inp">
                        <input type="text" class="inpbox  @error('name') ers @enderror" placeholder="Enter Product Name"
                            title="Please enter your name" name="name" value="{{ old('name') }}">
                    ...
                    <div class="mb-3 inp">
                        <input type="text" class="inpbox  @error('quantity') ers @enderror"
                            placeholder="Enter Product Quantity" title="Please enter product quantity" name="quantity"
                            value="{{ old('quantity') }}">
                    ...
                    <div class="mb-3">
                        <textarea name="description" rows="7" placeholder="Leave a comment"
